...
document.createXHTMLElement = function(tag) {
  ...
  document.getElementById('XHTMLForge').contentWindow.document.body.innerHTML = '<' + tag + '></' + tag + '>';
  let tg = document.getElementById('XHTMLForge').contetWindow.document.body.firstElementChild;
